...
import {loadSubThemes, ShowAddForm} from "./sub-theme-ui";
import {AddSubtheme, deleteSubTheme, showEditSubThemeForm} from "./sub-theme-restclient";
    ...
    document.getElementById('add-subtheme-button')?.addEventListener('click', () => {
        ...
        if (subThemasContainer) {
            ...
            document.getElementById('new-project-form')?.addEventListener('submit', async function (event) {
                ...
                const subThemeNameInput = document.getElementById('sub-theme-name') as HTMLInputElement;
                const subThemeInformationInput = document.getElementById('sub-theme-information') as HTMLTextAreaElement;
