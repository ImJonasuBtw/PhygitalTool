...
import {deleteAnswerPossibility, deleteQuestion} from "./flow-restclient";
            ...
            <form id="new-flow-form">
                ...
                <div class="mb-3">
                     <label class="form-label">Flow Type</label>
                         ...
                         <div class="form-check">
                              <input class="form-check-input" type="radio" name="flowType" id="linear-flow" value="Linear">
                              <label class="form-check-label" for="linear-flow"> Lineair</label>
                         </div>
                         
                </div>
                <div class="mb-3">
                    <label class="form-label">Taal</label>
                        <select class="form-select form-control" id="flow-language" required>
    ...
    FlowContainer.innerHTML = `
                    ...
                    <form id="edit-flow-form">
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            <label for="flow-logo" class="form-label">Flow Logo</label>
                            <img id="existing-flow-image" src="${flow.flowImage}" alt="foto">
                            <input type="file" class="form-control" id="flow-logo" accept="image/*">
                         </div>
                        ...
                        <label class="form-label">Flow Type</label>
                          <div class="form-check">
                                <input class="form-check-input" type="radio" name="flowType" id="circular-flow" value="Circular" ${flow.flowType === FlowTypeEnum.Circular ? 'checked' : ''}>
                                <label class="form-check-label" for="circular-flow"> Circulair </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="flowType" id="linear-flow" value="Linear" ${flow.flowType === FlowTypeEnum.Linear ? 'checked' : ''}>
                                <label class="form-check-label" for="linear-flow"> Lineair</label>
                            </div>
...
export function deleteQuestionButton(questionContainer: {
    remove: () => void;
...
export function deleteAnswerpossibilitiesButton(answerPossibilityAndButton: {
    remove: () => void;
    appendChild: (arg0: HTMLButtonElement) => void;
}, possibility: any): void {
    const deleteButtonPossibility = document.createElement('button');
...
export function showQuestionAndAnswerPossibilities(question: any, index: any, questionList: HTMLElement): void {
    ...
    question.answerPossibilities.forEach((possibility: {
        ...
        answerPossibilityAndButton.className = 'button-and-possibility row'
